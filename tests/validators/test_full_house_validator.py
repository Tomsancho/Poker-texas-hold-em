...
class FullHouseValidatorTest(unittest.TestCase):
    ...
    def test_validates_that_card_have_two_of_the_same_rank_and_three_of_another(self):
    ...
    def test_return_collection_of_two_cards_of_the_same_rank_and_three_cards_of_another(self):
        validator = FullHouseValidator(cards=self.cards)
